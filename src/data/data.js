...
// Koshary Al-Khedewy
import Koshary1 from '../images/stores/كشري الخديوي/Koshary1.png'
import Koshary2 from '../images/stores/كشري الخديوي/Koshary2.png'
import Koshary3 from '../images/stores/كشري الخديوي/Koshary3.png'
import Koshary4 from '../images/stores/كشري الخديوي/Koshary4.jpg'
import Koshary5 from '../images/stores/كشري الخديوي/Koshary5.jpg'
import Koshary6 from '../images/stores/كشري الخديوي/Koshary6.jpg'
import Koshary7 from '../images/stores/كشري الخديوي/Koshary7.jpg'
import Koshary8 from '../images/stores/كشري الخديوي/Koshary8.png'
import Koshary9 from '../images/stores/كشري الخديوي/tahaKoshary.png'
import beforeKoshary1 from '../images/stores/كشري الخديوي/beforeKoshary1.jpg'
import beforeKoshary2 from '../images/stores/كشري الخديوي/beforeKoshary2.jpg'
...
export const data = [
    {
        id: 1,
        category: 'shop',
        title: { en: 'Koshary El-Khedewy', ar: 'كشري الخديوي' },
        description: {
            en: 'Koshary El-Khedewy — one of Egypt’s most iconic koshary chains, with distinctive storefront signage handcrafted by me for multiple branches',
        ...
        materials: {
            en: ['Acrylic letters', 'LED lights', 'Aluminum composite panels'],
            ar: [' حروف أكريليك', ' إضاءة LED', ' ألواح ألومنيوم كومبوزيت']
        },
        services: {
            en: ['Design', 'Fabrication', 'Installation'],
            ar: ['التصميم', 'التصنيع', 'التركيب']
        }
    },
    {
        id: 2,
        category: 'shop',
        title: { en: 'Kids', ar: 'كيدز' },
        description: {
            en: 'Kids — a charming children’s clothing store, with custom storefront signage and branding handcrafted by me.',
            ar: 'كيدز – محل ملابس أطفال مميز، تم تنفيذ تصميم لافتاته وواجهة المحل بواسطتي.'
        },
        img: Kids3,
    ...
    },
    {
        id: 3,
        category: 'shop',
        title: { en: 'Happy Joes ', ar: 'هابي جوس' },
        description: {
            en: 'Happy Joe’s — a unique fast-food restaurant, with vibrant signage and visual branding crafted by me.',
    ...
    },
    {
        id: 4,
        category: 'shop',
        title: { en: 'Bingo', ar: 'بينجو' },
        description: {
            en: 'Bingo — a playful gift and toy shop, with colorful storefront signage designed and executed by me.',
            ar: 'بينجو – محل ألعاب وهدايا ممتع، قمت بتصميم وتنفيذ واجهته ولافتاته لتناسب طبيعته الحيوية.'
        },
        img: Bingo1,
    ...
    },
    {
        id: 5,
        category: 'shop',
        title: { en: 'Marsillia Beach ', ar: 'مارسيليا بيتش' },
        description: {
            en: 'Marsillia Beach — a seaside resort, with custom signage and visual identity elements created by me for key areas.',
            ar: 'مارسيليا بيتش – قرية سياحية على البحر، قمت بتنفيذ لافتاتها وتصميم الهوية البصرية لأجزاء مختلفة منه'
        },
        img: beach1,
    ...
    },
    {
        id: 6,
        category: 'shop',
        title: { en: 'Bazid Pharmacy', ar: 'صيدلية بازيد' },
        description: {
            en: 'Bazid Pharmacy — a modern pharmacy, with clean and professional signage designed by me to suit the healthcare field.',
            ar: 'صيدلية بازيد – صيدلية عصرية، قمت بتصميم لافتاتها بستايل واضح واحترافي يتماشى مع المجال الطبي'
        },
        img: Bazid1,
    ...
    },
    {
        id: 7,
        category: 'shop',
        title: { en: 'El Araby', ar: 'العربي' },
        description: {
            en: 'El Araby — one of the leading importers in El-Mahalla El-Kubra city, with bold and distinctive signage designed by me to reflect its commercial presence',
    ...
    },
    {
        id: 8,
        category: 'shop',
        title: { en: 'Hassan Ali', ar: 'حسن علي' },
        description: {
            en: 'Hassan Ali — one of the leading eyewear stores, with sleek and stylish signage designed by me to match the optical industry.',
            ar: 'حسن علي – من أكبر محلات النظارات في المنطقة، قمت بتصميم لافتاته بستايل أنيق يليق بمجال البصريات.'
        },
        img: ali1,
    ...
    },
    {
        id: 9,
        category: 'shop',
        title: { en: 'Falafels Xpress', ar: 'فلافلز إكسبريس' },
        description: {
            en: 'Falafels Xpress — a modern take on traditional falafel and fava bean dishes, with eye-catching signage designed by me.',
            ar: 'فلافلز إكسبريس – مطعم للفول والفلافل بنكهات سريعة ومميزة، قمت بتصميم لافتاته لتعبر عن الطابع الشعبي العصري'
        },
        img: xpress2,
    ...
    },
    {
        id: 10,
        category: 'shop',
        title: { en: 'Samaka ', ar: 'سماكة' },
        description: {
            en: 'Samaka — a cozy café with a distinct vibe, featuring custom storefront signage handcrafted by me.',
            ar: 'سماكة – كافيه بطابع خاص، تم تنفيذ تصميم واجهته ولافتاته بواسطتي لتعكس أجواءه المميزة.'
        },
        img: Samaka1,
    ...
    },
    {
        id: 11,
        category: 'shop',
        title: { en: 'Dawlya', ar: 'دولية' },
        description: {
            en: 'Dawlya — a trendy clothing store menswear, with modern signage crafted by me to reflect its fashion-forward image',
    ...
    },
    {
        id: 12,
        category: 'shop',
        title: { en: 'Nevin Pharmacy', ar: 'صيدلية نيفين' },
        description: {
            en: 'Nevin Pharmacy — a modern pharmacy, with clean and professional signage designed by me to suit the healthcare field.',
            ar: 'صيدلية نيفين – صيدلية عصرية، قمت بتصميم لافتاتها بستايل واضح واحترافي يتماشى مع المجال الطبي'
        },
        img: nevin1,
    ...
    },
    {
        id: 13,
        category: 'shop',
        title: { en: 'Other Selected Shops', ar: 'بعض المحلات الاخري' },
        description: {
            en: 'Other Selected Shops — a selection of smaller retail businesses, each with custom signage and storefront branding crafted by me to suit its unique identity and purpose',
            ar: 'بعض المحلات الأخرى – مجموعة من المحلات الصغيرة التي تم تنفيذ لافتاتها وتصميم واجهاتها بواسطتي، كل منها يحمل طابعه الخاص ويلبّي احتياجات مجاله.'
        },
        img: shop4,
    ...
    },
    {
        id: 14,
        category: 'stand',
        title: { en: 'T-Bull Stand', ar: 'ستاند تي بول' },
        description: {
            en: 'T-Bull Stand — custom-designed promotional display stands, crafted by me for effective use in retail spaces and exhibitions',
            ar: 'ستاند تي بول – وحدات عرض ترويجية (ستاندات) مميزة تستخدم في المحلات والمعارض، قمت بتصميمها وتنفيذها لتناسب الاستخدام التجاري والاحترافي.'
        },
        img: tStand4,
        ...
        materials: {
            en: ['MDF wood', 'Vinyl wrap', 'Metal support.'],
            ar: [' دعامة معدنية.', ' غلاف فينيل', ' خشب إم دي إف']
        },
        services: {
            en: ['Design', 'Printing', 'Assembly'],
            ar: ['التجميع', 'الطباعة', 'التصميم']
        }
    },
    {
        id: 15,
        category: 'stand',
        title: { en: 'Basic Stand', ar: 'ستاند بسيط' },
        description: {
            en: 'Basic Stand — custom-designed promotional display stands, crafted by me for effective use in retail spaces and exhibitions',
            ar: 'ستاند تي بول – وحدات عرض ترويجية (ستاندات) مميزة تستخدم في المحلات والمعارض، قمت بتصميمها وتنفيذها لتناسب الاستخدام التجاري والاحترافي.'
        },
        img: basicStand1,
    ...
    },
    {
        id: 16,
        category: 'house',
        title: { en: 'Villas', ar: 'فيلل' },
        description: {
            en: 'Premium villas with elegant finishes and unique designs, offering both luxury and privacy, crafted to the highest standards',
        ...
        materials: {
            en: ['Marble', 'Granite', 'High-quality paint.'],
    ...
    },
    {
        ...
        description: {
            en: 'Modern apartments with distinctive facades, designed and executed to deliver comfort and elegance in every detail.',
            ar: 'شقق بتصميمات عصرية وواجهات مميزة، تم تنفيذها بعناية لتوفير راحة وأناقة في كل التفاصيل'
        },
        img: apartment3,
    ...
    {
        id: 18,
        category: 'charcthers-light',
        title: { en: ' Illuminated Words', ar: 'كلمات مضيئة' },
        description: {
            en: 'Custom illuminated words tailored to suit various business needs, giving any space a strong and memorable visual identity',
            ar: 'كلمات مضيئة مصممة بعناية لتناسب مختلف الأنشطة التجارية، وتمنح المحل أو المساحة هوية بصرية مميزة'
        },
        img: word5,
        ...
        materials: {
            en: ['Acrylic', 'LED modules', 'Steel base.'],
            ar: ['  قاعدة فولاذية', ' وحدات LED', ' أكريليك']
        },
        services: {
            en: ['Cutting', 'Assembly', 'Electrical work'],
            ar: ['أعمال كهربائية', 'تجميع', 'قطع']
        }
    },
    {
        id: 19,
        category: 'charcthers-light',
        title: { en: 'Illuminated Letters', ar: 'حروف مضيئة' },
        description: {
            en: 'High-quality illuminated letter designs that bring a professional and eye-catching touch to storefronts and brand signage.',
            ar: 'تصميم وتنفيذ حروف مضيئة بجودة عالية، تضيف لمسة احترافية وجاذبية للواجهات والعلامات التجارية.'
        },
        img: char6,
